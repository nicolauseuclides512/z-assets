...
class RefreshRegionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    private function createTable()
    {
        ...
        CustomBlueprint::inst()->create('asset_regions', function (CustomBlueprint $table) {
            ...
            $table->bigInteger('lion_parcel_id')->unsigned()->nullable();
        ...
        DB::Transaction(function () {
            ...
            array_map(function ($x) {
                ...
                DB::table('asset_regions')->insert([
                    ...
                    'is_priority' => false,
                    'status' => true,
                    'created_at' => \Carbon\Carbon::now()->format('Y-m-d H:i:s.u0'),
                    'updated_at' => NULL,
                    'created_by' => 'System Migration'
                ]);

                printf('save ' . $x['region_id'] . '\n');
            }, $regionsCsvResult);
